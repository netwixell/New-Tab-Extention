	...
	<div class="right">
		<div class="details">
			<div class="summary material-icons gear" tl="title:transOption" title="Options">
				<img tl="title:transMenu" title="Menu" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABQAAAAMAQMAAABYwg+4AAAABGdBTUEAALGPC/xhBQAAAAFzUkdCAK7OHOkAAAAGUExURUdwTNzc3LlRXOkAAAABdFJOUwBA5thmAAAAGUlEQVQI12NgAIL0/w/AGAbS/0Mwgg+XBwAciQvlLNXN5AAAAABJRU5ErkJggg==" style="margin:4px;">
			</div>
			<div class="menu">
				<div>
